...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/script/app/Components/grid.scss":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/script/app/Components/grid.scss ***!
  \****************************************************************************************************************/
...
/***/ "./src/script/app/Components/ImageGrid.jsx":
/*!*************************************************!*\
  !*** ./src/script/app/Components/ImageGrid.jsx ***!
  \*************************************************/
...
/* harmony import */ var _grid_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./grid.scss */ "./src/script/app/Components/grid.scss");
...
/* harmony import */ var _ImageItem_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ImageItem.jsx */ "./src/script/app/Components/ImageItem.jsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
...
const ImageGrid = props => {
    const responseList = props.images.slice(0, 10).map(image => react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
        'li',
        { key: image.id.toString() },
        image.url
    ));

    const listItems = props.images.slice(0, 1).map(image => react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_ImageItem_jsx__WEBPACK_IMPORTED_MODULE_1__["ImageItem"], { key: image.id.toString(), url: image.url }));
...
/***/ "./src/script/app/Components/ImageItem.jsx":
/*!*************************************************!*\
  !*** ./src/script/app/Components/ImageItem.jsx ***!
  \*************************************************/
/*! exports provided: ImageItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const ImageItem = props => {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('img', { src: props.url, className: 'grid__img' })
    );
};

/***/ }),

/***/ "./src/script/app/Components/grid.scss":
/*!*********************************************!*\
  !*** ./src/script/app/Components/grid.scss ***!
  \*********************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!../../../../node_modules/sass-loader/lib/loader.js!./grid.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/script/app/Components/grid.scss");
...
/***/ "./src/script/app/Constants/constants.js":
/*!***********************************************!*\
  !*** ./src/script/app/Constants/constants.js ***!
  \***********************************************/
/*! exports provided: API_URL_CACHED, API_URL, API_TOGGLE, API_HEALTH, XML_SEARCH, TITLES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_URL_CACHED", function() { return API_URL_CACHED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_URL", function() { return API_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_TOGGLE", function() { return API_TOGGLE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_HEALTH", function() { return API_HEALTH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "XML_SEARCH", function() { return XML_SEARCH; });
...
const API_URL_CACHED = '/api/cats/cached';
const API_URL = '/api/cats';
const API_TOGGLE = '/api/busy';
const API_HEALTH = '/api/health';
const XML_SEARCH = 'image';
...
/***/ "./src/script/app/Containers/hello.jsx":
/*!*********************************************!*\
  !*** ./src/script/app/Containers/hello.jsx ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Components_ImageGrid_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Components/ImageGrid.jsx */ "./src/script/app/Components/ImageGrid.jsx");
/* harmony import */ var _register_worker_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../register-worker.js */ "./src/script/register-worker.js");
/* harmony import */ var _Services_catsApi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Services/catsApi.js */ "./src/script/app/Services/catsApi.js");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
/* harmony import */ var _Constants_constants_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Constants/constants.js */ "./src/script/app/Constants/constants.js");
...
class _Hello extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
            imagesArr: [],
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (workerName && !prevState.workers.includes(workerName)) {
            ...
            Object(_register_worker_js__WEBPACK_IMPORTED_MODULE_2__["registerWorker"])(workerName);
            return prevState;
        }
        return null;
    }
    ...
    checkServer() {
        _Services_catsApi_js__WEBPACK_IMPORTED_MODULE_3__["CatsApi"].checkServer().then(response => {
            this.setState({ isServerOn: response.ok });
        });
    }

    toggleServer() {
        _Services_catsApi_js__WEBPACK_IMPORTED_MODULE_3__["CatsApi"].toggleServer();
        this.setState({ isServerOn: !this.state.isServerOn });
    }

    fetchData() {
        this.setState({ imagesArr: [], imagesArrCache: [] });
        _Services_catsApi_js__WEBPACK_IMPORTED_MODULE_3__["CatsApi"].fetchData().then(imagesArr => {
            this.setState({ imagesArr });
        });

        _Services_catsApi_js__WEBPACK_IMPORTED_MODULE_3__["CatsApi"].fetchData('cache').then(imagesArrCache => {
            this.setState({ imagesArrCache });
        });
    }

    render() {
        const { first, second } = _Constants_constants_js__WEBPACK_IMPORTED_MODULE_5__["TITLES"][this.props.worker];
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                'button',
                { className: `btn-more ${serverClass}`, onClick: this.toggleServer },
                'server is ',
                serverClass.toUpperCase()
            ),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                'button',
                { className: 'btn-more', onClick: this.fetchData },
                'Show more'
            ),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                'div',
                { className: 'container' },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Components_ImageGrid_jsx__WEBPACK_IMPORTED_MODULE_1__["ImageGrid"], { images: this.state.imagesArr, title: first }),
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Components_ImageGrid_jsx__WEBPACK_IMPORTED_MODULE_1__["ImageGrid"], { images: this.state.imagesArrCache, title: second })
            )
        );
    }
}

/* harmony default export */ __webpack_exports__["default"] = (Object(react_router_dom__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(_Hello));

/***/ }),

/***/ "./src/script/app/Services/catsApi.js":
/*!********************************************!*\
  !*** ./src/script/app/Services/catsApi.js ***!
  \********************************************/
/*! exports provided: CatsApi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CatsApi", function() { return CatsApi; });
/* harmony import */ var _Constants_constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Constants/constants.js */ "./src/script/app/Constants/constants.js");


class CatsApi {

    static toggleServer() {
        fetch(_Constants_constants_js__WEBPACK_IMPORTED_MODULE_0__["API_TOGGLE"]);
    }

    static checkServer() {
        return fetch(_Constants_constants_js__WEBPACK_IMPORTED_MODULE_0__["API_HEALTH"]);
    }

    static fetchData(value = '') {
        let apiURL = _Constants_constants_js__WEBPACK_IMPORTED_MODULE_0__["API_URL"];
        if (value === 'cache') {
            apiURL = _Constants_constants_js__WEBPACK_IMPORTED_MODULE_0__["API_URL_CACHED"];
        }
    ...
    static handleXMLresponse(data) {
        ...
        const collection = xmlDoc.getElementsByTagName(_Constants_constants_js__WEBPACK_IMPORTED_MODULE_0__["XML_SEARCH"]);
        let imagesArr = [];
...
/* harmony import */ var _app_Containers_hello_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app/Containers/hello.jsx */ "./src/script/app/Containers/hello.jsx");
...
const BasicExample = () => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      ...
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          ...
          { activeClassName: 'link--active', to: 'cacheFirst' },
          'cacheFirst'
        )
      ),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          react_router_dom__WEBPACK_IMPORTED_MODULE_3__["NavLink"],
          { activeClassName: 'link--active', to: 'networkFirst' },
          'networkFirst'
        )
      )
    ),
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      ...
      null,
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["Route"], { path: '/cacheFirst', component: () => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_app_Containers_hello_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], { worker: 'cacheFirst' }) }),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["Route"], { path: '/networkFirst', component: () => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_app_Containers_hello_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], { worker: 'networkFirst' }) }),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__["Redirect"], { from: '*', to: '/cacheFirst' })
    )
  )
);

react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(BasicExample, null), document.getElementById('app'));

/***/ }),

/***/ "./src/script/register-worker.js":
/*!***************************************!*\
  !*** ./src/script/register-worker.js ***!
  \***************************************/
/*! exports provided: registerWorker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "registerWorker", function() { return registerWorker; });
const registerWorker = (type = 'cacheFirst') => {
...
const proceedRegister = (workerUrl, workerPath) => {
    navigator.serviceWorker.register(workerUrl, { scope: workerPath }).then(registration => {
